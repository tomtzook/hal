...
int hal_descriptor_table_insert(const hal_descriptor_table_t* table, void* ptr, size_t index);
int hal_descriptor_table_remove(const hal_descriptor_table_t* table, size_t index);
