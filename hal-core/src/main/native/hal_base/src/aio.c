...
hal_error_t hal_aio_get(hal_env_t* env, const hal_handle_t handle, uint32_t* value) {
...
hal_error_t hal_aio_set(hal_env_t* env, const hal_handle_t handle, const uint32_t value) {
    HAL_CHECK_FULL_INITIALIZED(env);
