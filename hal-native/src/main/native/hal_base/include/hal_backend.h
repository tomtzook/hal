...
struct _hal_backend {
    ...
    hal_error_t (*aio_get)(hal_env_t* env, const char* port_name, void* data, uint32_t* value);
    hal_error_t (*aio_set)(hal_env_t* env, const char* port_name, void* data, uint32_t value);
