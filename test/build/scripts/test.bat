...
set CLASSPATH=%APP_HOME%\lib\test.jar;%APP_HOME%\lib\hal.jar;%APP_HOME%\lib\castle-1.0.0-alpha.1.jar

@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_OPTS%  -classpath "%CLASSPATH%" hal.test.Main %CMD_LINE_ARGS%
